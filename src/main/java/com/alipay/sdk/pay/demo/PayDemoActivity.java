...
public class PayDemoActivity extends FragmentActivity {
	...
	/** 支付宝支付业务：入参app_id */
	public static final String APPID = "asdfasdfasfd";
	
	/** 支付宝账户登录授权业务：入参pid值 */
	public static final String PID = "asdfasdfadf";
